...
class Triangle(Shape):
    ...
    def __str__(self):
        return (f"Triangle(side_length={self.side_length}, "
                f"area={self.area():.2f}, perimeter={self.perimeter():.2f})")
...
def random_shape():
    ...
    if choice == "square":
        ...
        return Triangle(random.randint(1, 10))
        ...
        # Side length must be bitween the bounds (a−b)/2 to (a+b)/2 , converted to valid integer limits
